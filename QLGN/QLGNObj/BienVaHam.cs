...
namespace QLGN.QLGNObj
{
    class BienVaHam
    {
        #region Hàm
        public static string GiaiMa(string Message, string Passphrase)
        ...
        public static string MaHoa(string Message, string Passphrase)
        ...
        public static string TaoMa()
        {
            ...
            int a = rnd.Next(10000000, 999999999);
            ma = a.ToString();
            return ma;
        }
        #endregion
